	...
	<body>
		...
		<header class="am-topbar am-topbar-fixed-top">		
			<div class="am-topbar-left am-hide-sm-only">
                <a href="index.html" class="logo"><span>Gossip</span><i class="zmdi zmdi-layers"></i></a>
            </div>
				  ...
				  <div class="admin-sidebar am-offcanvas  am-padding-0" id="admin-offcanvas">
				    <div class="am-offcanvas-bar admin-offcanvas-bar">
						...
						<div class="user-box am-hide-sm-only">
	                        ...
	                        <h5><a href="#"><%=request.getSession().getAttribute("userRole")%>:<%=request.getSession().getAttribute("user")%></a> </h5>
						 ...
						 <ul class="am-list admin-sidebar-list">
						    ...
						    <li class="admin-parent">
						      ...
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav1">
						        <li><a href="html/table_basic.html" class="am-cf"> 数据统计</span></a></li>
						        <li><a href="html/table_complete.html">日志文件</a></li>
						      </ul>
						    </li>
						    <li class="admin-parent">
						      ...
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav2">
						        <li><a id="chart_line" href="#" class="am-cf"> 折线图</span></a></li>
			...
			<div class="content">
				...
				<div class="am-g">
					...
					<div class="am-g">
						...
						<div class="am-u-md-8">
							<div class="card-box">
								<h4 class="header-title m-t-0 m-b-30">最新说说</h4>
                                        ...
                                        <table class="am-table   am-text-nowrap">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>01/01/2016</td>
                                                    <td>26/04/2016</td>
                                                    <td><span class="label label-danger">正常</span></td>
                                                    <td>Coderthemes</td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>01/05/2016</td>
                                                    <td>10/05/2016</td>
                                                    <td><span class="label label-pink">未评论</span></td>
                                                    <td>Coderthemes</td>
                                                </tr>
                                                <tr>
                                                    <td>4</td>
                                                    ...
                                                    <td>01/01/2016</td>
                                                    <td>31/05/2016</td>
                                                    <td><span class="label label-purple">已评论</span>
                                                    </td>
                                                    <td>Adminto admin</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>01/01/2016</td>
                                                    <td>31/05/2016</td>
                                                    <td><span class="label label-warning">未评论</span></td>
                                                    <td>Coderthemes</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>01/01/2016</td>
                                                    <td>31/05/2016</td>
                                                    <td><span class="label label-primary">已评论</span></td>
                                                    <td>Adminto admin</td>
                                                </tr>
